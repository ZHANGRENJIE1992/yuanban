...
class Getieltsdetailinfo(views.APIView):
    ...
    def get(self, request):
        ...
        ielts_info = {
            ...
            'upImgArr': [IMAGES_URL + MEDIA_URL + w for w in ielts.wordimageset.split(',')],
            'upImgArr_read': [IMAGES_URL + MEDIA_URL + r for r in ielts.readimageset.split(',')],
            'upImgArr_listen': [IMAGES_URL + MEDIA_URL + l for l in ielts.listenimageset.split(',')],
            'upImgArr_write': [IMAGES_URL + MEDIA_URL + wr for wr in ielts.writeimageset.split(',')],
            'upImgArr_speak': [IMAGES_URL + MEDIA_URL + s for s in ielts.speakimageset.split(',')],
...
class Getgredetailinfo(views.APIView):
    ...
    def get(self, request):
        ...
        ielts_info = {
            ...
            'upImgArr': [IMAGES_URL + MEDIA_URL + w for w in ielts.wordimageset.split(',')],
            'upImgArr_read': [IMAGES_URL + MEDIA_URL + r for r in ielts.readimageset.split(',')],
            'upImgArr_blank': [IMAGES_URL + MEDIA_URL + l for l in ielts.fill_blank_imageset.split(',')],
            'upImgArr_write': [IMAGES_URL + MEDIA_URL + wr for wr in ielts.writeimageset.split(',')],
            'upImgArr_math': [IMAGES_URL + MEDIA_URL + s for s in ielts.mathimageset.split(',')],
            'signdate': datetime.date.strftime(ielts.signdate, "%Y-%m-%d"),
            'buqianstatus': ielts.buqianstatus,
            'username': user.name
        }
...
class Getgmatdetailinfo(views.APIView):
    ...
    def get(self, request):
        ...
        ielts_info = {
            ...
            'upImgArr': [IMAGES_URL + MEDIA_URL + w for w in ielts.wordimageset.split(',')],
            'upImgArr_read': [IMAGES_URL + MEDIA_URL + r for r in ielts.readimageset.split(',')],
            'upImgArr_grammar': [IMAGES_URL + MEDIA_URL + l for l in ielts.grammarimageset.split(',')],
            'upImgArr_write': [IMAGES_URL + MEDIA_URL + wr for wr in ielts.writeimageset.split(',')],
            'upImgArr_math': [IMAGES_URL + MEDIA_URL + s for s in ielts.mathimageset.split(',')],
            'upImgArr_logic': [IMAGES_URL + MEDIA_URL + s for s in ielts.logicimageset.split(',')],
            'signdate': datetime.date.strftime(ielts.signdate, "%Y-%m-%d"),
            'buqianstatus': ielts.buqianstatus,
            'username': user.name
        }
